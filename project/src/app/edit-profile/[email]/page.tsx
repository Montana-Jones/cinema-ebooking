...
interface Customer {
  ...
  bookings?: { id: string; numTickets: number; showTime: string; movieTitle: string }[];
  ...
  useEffect(() => {
    const fetchCustomer = async () => {
      try {
        ...
        // ✅ Data is already in camelCase in MongoDB, so no conversion
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-6 rounded-2xl shadow">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setCustomer((prev) => (prev ? { ...prev, promotion: e.target.value } : prev))
              }
          ...
          <div className="text-right">
            <a href="/change-password" className="text-blue-600 text-sm hover:underline">
              Change Password
            </a>
          </div>
